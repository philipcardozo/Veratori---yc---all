...
# Set authentication environment variables if not already set
if not os.getenv('AUTH_ENABLED'):
    os.environ['AUTH_ENABLED'] = 'true'
if not os.getenv('AUTH_SESSION_SECRET'):
    os.environ['AUTH_SESSION_SECRET'] = 'z2o_2f0CZkv-fWi2_hHxCxQtFqD0J_ohHXKI8NIgOic'
if not os.getenv('AUTH_SESSION_TTL'):
    os.environ['AUTH_SESSION_TTL'] = '86400'
if not os.getenv('AUTH_USERS_JSON'):
    os.environ['AUTH_USERS_JSON'] = '{"JustinMenezes":"$2b$12$RkpogBfSnYm34yPHyxeXiec3JewMSZZrClyEh42/XXw6OIFgN1u82","FelipeCardozo":"$2b$12$aaQcRwcUZa9tO5iHzuL4yuxC2Ik.0/KcoD3ATL./rZlzkiuOyTThS"}'
